...
!19681      format(i5,1x,f8.4,1x,f8.2,2(1x,f8.4),1x,e15.6)
        ...
        write(25,19672)
19672   format('    rhox   T   Pg   Ne   kross')
         do k=1,ndepth_ref
           merdape=10**Pe(k,out)
           merdapg=10**Pg(k,out)
           merdakr=10**xkapref(k,out)
           write(25,19681) rhox(k,out),T(k,out),Pg(k,out),Pe(k,out),
     &                     merdakr
c19681      format(2x,i5,2x,2f10.4,2x,f11.4)
19681      format(1x,E15.8,2X,F7.1,1X,E10.3, 1X,E10.3,1X,E10.3)
