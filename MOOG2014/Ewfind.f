...
c               write (nf2out,1013) tauref(i), i
               go to 10
            endif
         enddo
...
c               write (nf2out,1014) tauref(i), i
               go to 20
            endif
         enddo
...
c               write (nf2out,1015) tauref(i), i
               go to 30
            endif
         enddo
...
c               write (nf2out,1017) 10**(xrefmean), i
               go to 40
            endif
         enddo
40       continue
...
1001  format (/'wavelength        EP     logGF     ident',
     .        '     Abund    EWcalc')
1002  format (a80)
1003  format (f10.2,f10.2,f10.3,'     ',a2,a3,f10.2,f10.2)
1004  format (f10.2, f10.2, f10.3, 6x, a2, a2, f10.2, f10.2)
